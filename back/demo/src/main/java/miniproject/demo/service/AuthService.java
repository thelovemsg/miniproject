...
import miniproject.demo.config.RefreshToken;
...
import miniproject.demo.jwt.TokenProvider;
import miniproject.demo.repository.MemberRepository;
import miniproject.demo.repository.RefreshTokenRepository;
...
public class AuthService {
    ...
    public MemberResponseDto signup(MemberRequestDto memberRequestDto) {
        if (memberRepository.existsByEmail(memberRequestDto.getEmail())) {
            return new MemberResponseDto(ResultEnum.DUPLICATE.getKey());
        }
